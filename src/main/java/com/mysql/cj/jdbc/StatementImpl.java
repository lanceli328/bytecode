...
//
//  /**
//   * Mutex to prevent race between returning query results and noticing that we're timed-out or
//   * cancelled.
//   */
//
...
//   */
//  protected int maxFieldSize = (Integer) PropertyDefinitions
//      .getPropertyDefinition(PropertyDefinitions.PNAME_maxAllowedPacket).getDefaultValue();
//
//  /**
...
//      throw SQLError.createSQLException(Messages.getString("Statement.0"),
...
//
//    this.autoGenerateTestcaseScript = c.getPropertySet()
//        .getReadableProperty(PropertyDefinitions.PNAME_autoGenerateTestcaseScript);
//    this.dontTrackOpenResources = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_dontTrackOpenResources);
//    this.dumpQueriesOnException = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_dumpQueriesOnException);
//    this.explainSlowQueries = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_explainSlowQueries);
//    this.gatherPerfMetrics = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_gatherPerfMetrics);
//    this.continueBatchOnError = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_continueBatchOnError).getValue();
//    this.pedantic = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_pedantic).getValue();
//    this.slowQueryThresholdMillis = c.getPropertySet()
//        .getIntegerReadableProperty(PropertyDefinitions.PNAME_slowQueryThresholdMillis);
//    this.rewriteBatchedStatements = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_rewriteBatchedStatements);
//    this.charEncoding = c.getPropertySet()
//        .getStringReadableProperty(PropertyDefinitions.PNAME_characterEncoding).getValue();
//    this.profileSQL = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_profileSQL).getValue();
//    this.useUsageAdvisor = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_useUsageAdvisor).getValue();
//    this.logSlowQueries = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_logSlowQueries).getValue();
//    this.useCursorFetch = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_useCursorFetch).getValue();
//    this.maxAllowedPacket = c.getPropertySet()
//        .getIntegerReadableProperty(PropertyDefinitions.PNAME_maxAllowedPacket);
//    this.dontCheckOnDuplicateKeyUpdateInSQL = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_dontCheckOnDuplicateKeyUpdateInSQL)
//        .getValue();
//    this.sendFractionalSeconds = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_sendFractionalSeconds);
//    this.doEscapeProcessing = c.getPropertySet()
//        .getBooleanReadableProperty(PropertyDefinitions.PNAME_enableEscapeProcessing).getValue();
//
...
//    }
//
//    int defaultFetchSize = this.connection.getPropertySet()
//        .getIntegerReadableProperty(PropertyDefinitions.PNAME_defaultFetchSize).getValue();
...
//    }
//
//    int maxRowsConn = this.connection.getPropertySet()
//        .getIntegerReadableProperty(PropertyDefinitions.PNAME_maxRows).getValue();
//
//    if (maxRowsConn != -1) {
...
//        .<Boolean>getModifiableProperty(PropertyDefinitions.PNAME_holdResultsOpenOverStatementClose)
//        .getValue();
//
...
//   * contain any combination of String, BatchParams, or BatchedBindValues depending on how the
...
//   * This method can be used by one thread to cancel a statement that is being executed by another
//   * thread.
//   */
...
//
//    if (c == null) {
//      throw ExceptionFactory.createException(StatementIsClosedException.class,
//          Messages.getString("Statement.AlreadyClosed"), getExceptionInterceptor());
//    }
//
//    return c;
//  }
//
//  /**
//   * Checks if the given SQL query with the given first non-ws char is a DML statement. Throws an
//   * exception if it is.
//   *
...
//        || (firstStatementChar == 'C') || (firstStatementChar == 'T') || (firstStatementChar
//        == 'R')) {
//      String noCommentSql = StringUtils.stripComments(sql, "'\"", "'\"", true, false, true, true);
//
//      if (StringUtils.startsWithIgnoreCaseAndWs(noCommentSql, "INSERT") || StringUtils
//          .startsWithIgnoreCaseAndWs(noCommentSql, "UPDATE")
//          || StringUtils.startsWithIgnoreCaseAndWs(noCommentSql, "DELETE") || StringUtils
//          .startsWithIgnoreCaseAndWs(noCommentSql, "DROP")
//          || StringUtils.startsWithIgnoreCaseAndWs(noCommentSql, "CREATE") || StringUtils
//          .startsWithIgnoreCaseAndWs(noCommentSql, "ALTER")
//          || StringUtils.startsWithIgnoreCaseAndWs(noCommentSql, "TRUNCATE") || StringUtils
//          .startsWithIgnoreCaseAndWs(noCommentSql, "RENAME")) {
//        throw SQLError.createSQLException(Messages.getString("Statement.57"),
...
//    if (sql == null) {
//      throw SQLError.createSQLException(Messages.getString("Statement.59"),
//          SQLError.SQL_STATE_ILLEGAL_ARGUMENT, getExceptionInterceptor());
//    }
//
//    if (sql.length() == 0) {
//      throw SQLError.createSQLException(Messages.getString("Statement.61"),
//          SQLError.SQL_STATE_ILLEGAL_ARGUMENT, getExceptionInterceptor());
//    }
//  }
//
...
//   * Statement is closed, its current ResultSet, if one exists, is also closed. </p>
//   *
...
//    try {
//      synchronized (checkClosed().getConnectionMutex()) {
//        if (isCloseOnCompletion() && !this.dontTrackOpenResources.getValue()
//            && getOpenResultSetCount() == 0
//            && (this.results == null || !this.results.hasRows() || this.results.isClosed())
//            && (this.generatedKeysResults == null || !this.generatedKeysResults.hasRows()
...
//    synchronized (checkClosed().getConnectionMutex()) {
//      java.sql.PreparedStatement pStmt = this.connection
//          .prepareStatement(sql, this.resultSetType, this.resultSetConcurrency);
//
...
//    return ((this.resultSetType == ResultSet.TYPE_FORWARD_ONLY) && (this.resultSetConcurrency
...
//    int netTimeoutForStreamingResults = this.session.getPropertySet()
//        .getIntegerReadableProperty(PropertyDefinitions.PNAME_netTimeoutForStreamingResults)
//        .getValue();
//
...
//          returnGeneratedKeys && firstNonWsChar == 'I' && containsOnDuplicateKeyInString(sql);
//
...
//          Object escapedSqlResult = EscapeProcessor
//              .escapeSQL(sql, this.session.getDefaultTimeZone(),
//                  this.session.serverSupportsFracSecs(),
//                  getExceptionInterceptor());
//
...
//
//          try {
//            if (locallyScopedConn.getPropertySet()
//                .getBooleanReadableProperty(PropertyDefinitions.PNAME_enableQueryTimeouts)
//                .getValue()
...
//
//            if (locallyScopedConn.getPropertySet()
//                .getBooleanReadableProperty(PropertyDefinitions.PNAME_cacheResultSetMetadata)
//                .getValue()) {
...
//            statementBegins();
//
//            rs = locallyScopedConn
//                .execSQL(this, sql, this.maxRows, null, createStreamingResultSet(),
//                    this.currentCatalog, cachedMetaData);
//
//            if (timeoutTask != null) {
...
//            } else {
//              if (this.session.getPropertySet()
//                  .getBooleanReadableProperty(PropertyDefinitions.PNAME_cacheResultSetMetadata)
//                  .getValue()) {
//                locallyScopedConn
//                    .initializeResultsMetadataFromCache(sql, null /* will be created */,
//                        this.results);
//              }
//            }
//          }
...
//                .getBooleanReadableProperty(PropertyDefinitions.PNAME_allowMultiQueries)
//                .getValue();
//
//            if (multiQueriesEnabled
//                || (locallyScopedConn.getPropertySet()
//                .getBooleanReadableProperty(PropertyDefinitions.PNAME_rewriteBatchedStatements)
//                .getValue()
//                && nbrCommands > 4)) {
...
//            if (sqlEx != null) {
//              throw SQLError
//                  .createBatchUpdateException(sqlEx, updateCounts, getExceptionInterceptor());
//            }
//          }
//
//          if (timeoutTask != null) {
...
//   */
//  private long[] executeBatchUsingMultiQueries(boolean multiQueriesEnabled, int nbrCommands,
...
//
//        if (locallyScopedConn.getPropertySet()
//            .getBooleanReadableProperty(PropertyDefinitions.PNAME_enableQueryTimeouts).getValue()
//            && individualStatementTimeout != 0) {
...
//
//        String connectionEncoding = locallyScopedConn.getPropertySet()
...
//              + MysqlaConstants.HEADER_LENGTH) * escapeAdjust) + 32 > this.maxAllowedPacket
//              .getValue()) {
//            try {
//              batchStmt.execute(queryBuf.toString(), java.sql.Statement.RETURN_GENERATED_KEYS);
//            } catch (SQLException ex) {
//              sqlEx = handleExceptionForBatch(commandIndex, argumentSetsInBatchSoFar, updateCounts,
//                  ex);
//            }
//
...
//            batchStmt.execute(queryBuf.toString(), java.sql.Statement.RETURN_GENERATED_KEYS);
//          } catch (SQLException ex) {
//            sqlEx = handleExceptionForBatch(commandIndex - 1, argumentSetsInBatchSoFar,
//                updateCounts, ex);
//          }
//
//          counter = processMultiCountsAndKeys((StatementImpl) batchStmt, counter, updateCounts);
...
//  }
//
//  protected int processMultiCountsAndKeys(StatementImpl batchedStatement, int updateCountCounter,
//      long[] updateCounts) throws SQLException {
//    synchronized (checkClosed().getConnectionMutex()) {
...
//  }
//
//  protected SQLException handleExceptionForBatch(int endOfBatchIndex, int numValuesPerBatch,
//      long[] updateCounts, SQLException ex)
...
//
//      if (this.doEscapeProcessing) {
//        Object escapedSqlResult = EscapeProcessor.escapeSQL(sql, this.session.getDefaultTimeZone(),
//            this.session.serverSupportsFracSecs(),
//            getExceptionInterceptor());
//
//        if (escapedSqlResult instanceof String) {
...
//        statementBegins();
//
//        this.results = locallyScopedConn
//            .execSQL(this, sql, this.maxRows, null, createStreamingResultSet(), this.currentCatalog,
//                cachedMetaData);
//
//        if (timeoutTask != null) {
//          if (timeoutTask.caughtWhileCancelling != null) {
...
//        } catch (Exception e) {
//          throw SQLError
//              .createSQLException(e.getMessage(), SQLError.SQL_STATE_COMMUNICATION_LINK_FAILURE, e,
//                  getExceptionInterceptor());
//        }
//      } else {
...
//          .createFromResultsetRows(ResultSet.CONCUR_READ_ONLY, ResultSet.TYPE_SCROLL_INSENSITIVE,
...
//        rs = locallyScopedConn
//            .execSQL(this, sql, -1, null, false, this.currentCatalog, null, isBatch);
//
//        if (timeoutTask != null) {
//          if (timeoutTask.caughtWhileCancelling != null) {
//            throw timeoutTask.caughtWhileCancelling;
...
//      fields[0] = new Field("", "GENERATED_KEY", collationIndex, encoding,
//          MysqlType.BIGINT_UNSIGNED, 20);
//
//      this.generatedKeysResults = this.resultSetFactory
//          .createFromResultsetRows(ResultSet.CONCUR_READ_ONLY, ResultSet.TYPE_SCROLL_INSENSITIVE,
//              new ResultsetRowsStatic(this.batchedGeneratedKeys,
//                  new MysqlaColumnDefinition(fields)));
//
...
//        }
//
//        if ((beginAt != 0 /* BIGINT UNSIGNED can wrap the protocol representation */) && (numKeys
//            > 0)) {
...
//      }
//
//      ResultSetImpl gkRs = this.resultSetFactory
//          .createFromResultsetRows(ResultSet.CONCUR_READ_ONLY, ResultSet.TYPE_SCROLL_INSENSITIVE,
...
//   * before one gets a chance to call "select LAST_INSERT_ID()". </p>
//   *
...
//   *
//   * <p> This method returns longs as MySQL server returns 64-bit values for update counts </p>
//   *
...
//      }
//
//      ResultSetInternalMethods nextResultSet = (ResultSetInternalMethods) this.results
//          .getNextResultset();
//
//      switch (current) {
...
//
//        default:
//          throw SQLError.createSQLException(Messages.getString("Statement.19"),
//              SQLError.SQL_STATE_ILLEGAL_ARGUMENT, getExceptionInterceptor());
//      }
//
...
//   *
//   * <p> The Warning chain is automatically cleared each time a statement is (re)executed. </p>
//   *
//   * <p> <B>Note:</B> If you are processing a ResultSet then any warnings associated with ResultSet
//   * reads will be chained on the ResultSet object. </p>
//   *
...
//      }
//
//      SQLWarning pendingWarningsFromServer = ResultSetUtil
...
//            new ProfilerEventImpl(ProfilerEvent.TYPE_WARN, "", this.currentCatalog,
//                this.connectionId, this.getId(), -1,
...
//   *
//   * <p> <b>Note:</b> This MySQL driver does not support cursors. </p>
//   *
...
//   * The hint applies only to result sets created using this Statement object. The default value is
//   * ResultSet.FETCH_FORWARD.
//   *
//   * @param direction the initial direction for processing rows
//   * @throws SQLException if a database-access error occurs or direction is not one of
...
//
//      default:
//        throw SQLError.createSQLException(Messages.getString("Statement.5"),
//            SQLError.SQL_STATE_ILLEGAL_ARGUMENT, getExceptionInterceptor());
//    }
//  }
//
//  /**
//   * JDBC 2.0 Give the JDBC driver a hint as to the number of rows that should be fetched from the
//   * database when more rows are needed. The number of rows specified only affects result sets
...
//    synchronized (checkClosed().getConnectionMutex()) {
//      if (((rows < 0) && (rows != Integer.MIN_VALUE)) || ((this.maxRows > 0) && (rows > this
//          .getMaxRows()))) {
//        throw SQLError.createSQLException(Messages.getString("Statement.7"),
//            SQLError.SQL_STATE_ILLEGAL_ARGUMENT, getExceptionInterceptor());
//      }
//
//      this.fetchSize = rows;
...
//    synchronized (checkClosed().getConnectionMutex()) {
//      if (max < 0) {
//        throw SQLError.createSQLException(Messages.getString("Statement.11"),
//            SQLError.SQL_STATE_ILLEGAL_ARGUMENT, getExceptionInterceptor());
//      }
//
...
//    synchronized (checkClosed().getConnectionMutex()) {
//      if (seconds < 0) {
//        throw SQLError.createSQLException(Messages.getString("Statement.21"),
//            SQLError.SQL_STATE_ILLEGAL_ARGUMENT, getExceptionInterceptor());
//      }
//
...
//    synchronized (checkClosed().getConnectionMutex()) {
//      return this.useCursorFetch && this.fetchSize > 0
//          && this.resultSetType == ResultSet.TYPE_FORWARD_ONLY;
//    }
//  }
//
...
//    return getOnDuplicateKeyLocation(sql, this.dontCheckOnDuplicateKeyUpdateInSQL,
//        this.rewriteBatchedStatements.getValue(),
//        this.connection.isNoBackslashEscapesSet()) != -1;
//  }
//
//  protected static int getOnDuplicateKeyLocation(String sql,
//      boolean dontCheckOnDuplicateKeyUpdateInSQL, boolean rewriteBatchedStatements,
...
//            "\"'`", "\"'`", noBackslashEscapes ? StringUtils.SEARCH_MODE__MRK_COM_WS
...
//
//  /**
//   * JDBC 4.2 Same as {@link #executeBatch()} but returns long[] instead of int[].
//   */
...
//
//  /**
//   * JDBC 4.2 Same as {@link #executeUpdate(String)} but returns long instead of int.
//   */
...
//
//  /**
//   * JDBC 4.2 Same as {@link #executeUpdate(String, int)} but returns long instead of int.
//   */
...
//
//  /**
//   * JDBC 4.2 Same as {@link #executeUpdate(String, String[])} but returns long instead of int.
//   */
...
//
//  /**
//   * JDBC 4.2 Same as {@link #getMaxRows()} but returns long instead of int.
//   */
...
//
//  /**
//   * JDBC 4.2 Same as {@link #getUpdateCount()} but returns long instead of int;
//   */
...
//
//  /**
//   * JDBC 4.2 Same as {@link #setMaxRows(int)} but accepts a long value instead of an int.
//   */
//  public void setLargeMaxRows(long max) throws SQLException {
//    synchronized (checkClosed().getConnectionMutex()) {
//      if ((max > MAX_ROWS) || (max < 0)) {
//        throw SQLError
//            .createSQLException(Messages.getString("Statement.15") + max + " > " + MAX_ROWS + ".",
//                SQLError.SQL_STATE_ILLEGAL_ARGUMENT,
//                getExceptionInterceptor());
//      }
//
...
//    throw ExceptionFactory.createException(CJOperationNotSupportedException.class,
//        Messages.getString("Statement.65"));
//  }
//
